                  ...
                  {!showResult ? (
                    <>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div 
                          className="card bg-gray-50 p-3 rounded-lg cursor-pointer hover:bg-gray-100 transition"
                          onClick={() => handleCardClick("dummy hdbsdbdj sdjsdb")}
                        >
                          <p className="text-sm text-gray-700">dummy hdbsdbdj sdjsdb</p>
