...
const Navadmin = () => {
  ...
  return (
    <div className='flex justify-between items-center px-4 sm:px-10 py-3 border-b bg-white'>
        ...
        <img className='w-36 sm:w-40 cursor-pointer' src={assets.Docushed} alt="" />
        <p className='border px-2.5 py-0.5 rounded-full border-gray-500 text-gray-600'>{userdata.role==='admin' ?'Admin':'Doctor'}</p>
        </div>
