...
const AllPayments = () => {
  ...
  const handleRefund = async (paymentId) => {
    try {
      await axios.post(`${backendUrl}/api/payments/${paymentId}/refund`);
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        ...
        <div className="relative w-full md:w-96">
          ...
          <input
            ...
            placeholder="Search by Payment ID, Appointment ID, or Doctor"
            value={searchTerm}
              ...
              {filteredPayments.length > 0 ? (
                filteredPayments.map((payment) => (
                  <tr key={payment._id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{payment.appointmentId}</td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="flex-shrink-0 h-10 w-10">
                          <img className="h-10 w-10 rounded-full" src={payment.doctorId.image} alt={payment.doctorId.name} />
                        </div>
                        <div className="ml-4">
                          <div className="text-sm font-medium text-gray-900">{payment.doctorId.name}</div>
                        </div>
                      </div>
                    </td>
                      ...
                      {editingId === payment._id ? (
                        ...
                        <div className="flex space-x-2">
                          ...
                          <button
                            ...
                            className={`${payment.status === 'pending' ? 'text-green-600 hover:text-green-900' : 'text-gray-400 cursor-not-allowed'}`}
                          >
                            Refund
                          </button>
                        </div>
